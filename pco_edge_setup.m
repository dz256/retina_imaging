function [errorCode,glvar] = pco_edge_setup(set_default,glvar,exposure_time,currentTriggerMode, binNum, roix0, roix1, roiy0, roiy1, IRSensitivity, conversion)
...
roi_x0=uint16(1);
roi_x1=uint16(1392 / binNum);
roi_y0=uint16(1);
roi_y1=uint16(1040 / binNum);
...
triggermode = uint16(currentTriggerMode);
...
%set ROI
errorCode = calllib('PCO_CAM_SDK', 'PCO_SetROI', out_ptr,roi_x0,roi_y0,roi_x1,roi_y1);
pco_errdisp('PCO_SetROI',errorCode);

[errorCode,~,roi_x0,roi_y0,roi_x1,roi_y1] = calllib('PCO_CAM_SDK', 'PCO_GetROI', out_ptr,roi_x0,roi_y0,roi_x1,roi_y1);
pco_errdisp('PCO_GetROI',errorCode);

disp(['PCO_ROI ',int2str(roi_x0),' ',int2str(roi_x1),' ',int2str(roi_y0),' ',int2str(roi_y1),' ',]);
