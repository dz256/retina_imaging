function [errorCode] = pco_edge_live_add(looptime,triggermode)
% grab and display images in a loop
%
%   [errorCode] = pco_edge_live_add(looptime,triggermode)
%
% * Input parameters :
...
disp([num2str(nr_of_images),' images will be grabbed in ',num2str(looptime),' seconds' ]);   
